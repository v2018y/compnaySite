...
<body>
    ...
    <div class="gallery pt-5">
        <div class="container pt-xl-5 pt-lg-3">
            ...
            <p class="title-para text-center mx-auto mb-sm-5 mb-4">This our Company Product List, here gives a quick
                review of our company products which is sucessfully done.</p>
            <ul class="demo">
                <?php
                ...
                <li>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo $row['prodDisc'] ?></p>
                        </div>
                    </div>
                </li>
                <?php
